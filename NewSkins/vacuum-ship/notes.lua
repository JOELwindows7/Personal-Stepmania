...
return function(button_list, stepstype)
	...
	local head_rots= {Left= 90, Down= 0, Up= 180, Right= 270, UpLeft= 0, UpRight= 0, Center=0}
	...
	local hold_buttons= {
		Left= "Left", Right= "Left", Down= "Down", Up= "Down", UpLeft= "UpLeft", UpRight= "UpLeft", Center="Center"
	}
	local roll_buttons= {
		Left= "Left", Right= "Left", Down= "Down", Up= "Down", UpLeft= "UpLeft", UpRight= "UpLeft", Center="Center"
	}
	local Hold_Head= {
		Left= "Down", Right= "Down", Down= "Down", Up= "Down", UpLeft= "UpLeft", UpRight= "UpLeft", Center= "Center"
	}
	local hold_length= {
		start_note_offset= -.5,
		end_note_offset= .5,
		...
		columns[i]= {
			...
			taps= {
				NewSkinTapPart_Tap= {
					...
					actor= Def.Sprite{Texture= "Tap Note 8x8.png",
				...
				NewSkinTapPart_Lift= { -- don't fuck lifts!
					...
					actor= Def.Sprite{Texture= NEWSKIN:get_path(skin_name, "Tap Note 8x8.png"),
						InitCommand= function(self) self:rotationz(rots[button]) end}},
